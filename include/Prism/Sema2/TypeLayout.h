#ifndef PRISM_SEMA2_TYPELAYOUT_H
#define PRISM_SEMA2_TYPELAYOUT_H
...
public:
    ...
    bool is_complete() const { return _align < (size_t)-2; }

    /// \Returns true if this layout is incomplete
    bool is_incomplete() const { return *this == TypeLayout::Incomplete; }

    /// \Returns true if this layout is poison
    bool is_poison() const { return *this == TypeLayout::Poison; }

    /// \Returns `is_complete()`
    explicit operator bool() const { return is_complete(); }
...
#endif // PRISM_SEMA2_TYPELAYOUT_H
